...
public class TerminosYCondiciones extends AppCompatActivity {
    ...
    private void cargarPictogramas(){
        ...
        if(dbHandler.count()==0){
            ...
            //============ ESTADOS DE ANIMO
            dbHandler.addUser(new Pictograma("Aburrido", 3,R.drawable.ic_tablero_estados_animo_aburrido ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Asustado", 3,R.drawable.ic_tablero_estados_animo_asustado ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Cansado", 3,R.drawable.ic_tablero_estados_animo_cansado ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Confundido", 3,R.drawable.ic_tablero_estados_animo_confundido ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Enamorado", 3,R.drawable.ic_tablero_estados_animo_enamorado ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Enfermo", 3,R.drawable.ic_tablero_estados_animo_enfermo ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Enojado", 3,R.drawable.ic_tablero_estados_animo_enojado ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Feliz", 3,R.drawable.ic_tablero_estados_animo_feliz ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Hambriento", 3,R.drawable.ic_tablero_estados_animo_hambriento ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Pensativo", 3,R.drawable.ic_tablero_estados_animo_pensativo ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Saludable", 3,R.drawable.ic_tablero_estados_animo_saludable ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Somnoliento", 3,R.drawable.ic_tablero_estados_animo_somnoliento ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Sorprendido", 3,R.drawable.ic_tablero_estados_animo_sorprendido ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Triste", 3,R.drawable.ic_tablero_estados_animo_triste ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Vergüenza", 3,R.drawable.ic_tablero_estados_animo_verguenza ,Pictograma.PIC_NORMAL));

            //============ LUGARES
            dbHandler.addUser(new Pictograma("Casa", 12,R.drawable.ic_tablero_lugares_casa ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Cine", 12,R.drawable.ic_tablero_lugares_cine ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Escuela", 12,R.drawable.ic_tablero_lugares_escuela ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Hospital", 12,R.drawable.ic_tablero_lugares_hospital ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Iglesia", 12,R.drawable.ic_tablero_lugares_iglesia ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Mercado", 12,R.drawable.ic_tablero_lugares_mercado ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Museo", 12,R.drawable.ic_tablero_lugares_museo ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Parque", 12,R.drawable.ic_tablero_lugares_parque ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Tienda", 12,R.drawable.ic_tablero_lugares_tienda ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Zoológico", 12,R.drawable.ic_tablero_lugares_zoologico ,Pictograma.PIC_NORMAL));

            //============ FAMILIA
            dbHandler.addUser(new Pictograma("Abuelita", 10,R.drawable.ic_tablero_familia_abuelita ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Abuelito", 10,R.drawable.ic_tablero_familia_abuelito ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Hermana", 10,R.drawable.ic_tablero_familia_hermana ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Hermano", 10,R.drawable.ic_tablero_familia_hermano ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Mamá", 10,R.drawable.ic_tablero_familia_mama ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Papá", 10,R.drawable.ic_tablero_familia_papa ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Prima", 10,R.drawable.ic_tablero_familia_prima ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Primo", 10,R.drawable.ic_tablero_familia_primo ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Tía", 10,R.drawable.ic_tablero_familia_tia ,Pictograma.PIC_NORMAL));
            dbHandler.addUser(new Pictograma("Tío", 10,R.drawable.ic_tablero_familia_tio ,Pictograma.PIC_NORMAL));
